...
Doodle.BootState = {
    ...
    preload: function() {
        this.load.image("loadingscreen", "assets/images/Preloader2.png"),
        this.load.image("cloudgameslogo", "assets/images/Preloader21.png"),
        this.load.image("limaskylogo", "assets/images/Preloader22.png")
    },
    create: function() {
...
Doodle.CalibrateState = {
    ...
    create: function() {
        ...
        function e() {
            if (b) {
                ...
                d.cursorContr || d.game.paused || !d.player.alive || (d.player.body.velocity.x = 40 * a.gamma * Math.cos(a.beta * Math.PI / 180) + d.calibratedValue,
    ...
    collide: function(a, b) {
        a.body.velocity.y > 0 && this.jumpSound.play(),
        ...
        if (a && b) {
            ...
            e(f, function(a) {
                var b = a.message ? "message" : "data"
                  , d = a[b];
                console.log("game", d),
                d.mssg && "deviceorientation" == d.mssg && "Calibrate" == Doodle.game.state.current && (console.log(d.event.alpha, d.event.beta, d.event.gamma),
                c.cursorContr || c.game.paused || !c.player.alive || (c.player.body.velocity.x = d.event.gamma * c.GYRO_SENSE * Math.cos(d.event.beta * Math.PI / 180) + c.calibratedValue,
...
Doodle.GameState = {
    ...
    create: function() {
        ...
        this.appstore.events.onInputUp.add(function() {//window.open("https://itunes.apple.com/us/app/doodle-jump-free-be-warned/id456355158?utm_source=web%20game&utm_medium=online&utm_campaign=html5_pilot", "_blank")
        }, this),
        this.googleplay = new Phaser.Sprite(this.game,10,690,"googleplay"),
        this.googleplay.inputEnabled = !0,
        this.googleplay.events.onInputUp.add(function() {//window.open("https://play.google.com/store/apps/details?id=com.lima.doodlejump&utm_source=web%20game&utm_medium=online&utm_campaign=html5_pilot", "_blank")
        }, this),
        ...
        this.loadScoreMarks();
        var a, b = (-1 != navigator.userAgent.indexOf("AppleWebKit"),
        /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream,
        ...
        function d() {
            if (a) {
                ...
                c.cursorContr || c.game.paused || !c.player.alive || (c.player.body.velocity.x = b.gamma * c.GYRO_SENSE * Math.cos(b.beta * Math.PI / 180) + c.calibratedValue,
    ...
    update: function() {
        ...
        this.player.alive && (this.platformPool.forEach(function(a) {
            a.top >= this.game.world.height - this.platformPool.y && a.kill()
        }, this),
        this.bonusPool.forEach(function(a) {
            a.top >= this.game.world.height - this.bonusPool.y && ("bonus2" == a.type && !a.used && a.alive && (this.stats.achievements[10][2] += 1,
            this.stats.achievements[10][2] >= 3 && this.achieveMentUnlock(10)),
            a.kill())
        }, this),
        this.obstaclePool.forEach(function(a) {
            a.top >= this.game.world.height - this.obstaclePool.y && (a.alive && 4 != a.type && (this.stats.achievements[4][2] += 1,
        ...
        if ("fearless" != this.name) {
            ...
            0 == a) {
                ...
                this.death % 5 === 0) {
                    ...
                    this.popUPMenu.playNow.anchor.setTo(.5),
                    ...
                    for (var d = 0, e = 0; e < c.length; e++) {
                        ...
                        i.inputEnabled = !0,
                        i.link = g,
                        i.events.onInputUp.add(function(a) {//window.open(a.link, "_blank")
                        }, this),
            ...
            2 == a && (this.player.body.velocity.y < 0 && (this.player.body.velocity.y = 0),
            ...
            offsetY = 0,
            offsetTime = 0,
            6 == b.type && b.animations.currentAnim ? (offsetX = 0,
            offsetY = -80) : 4 == b.type && (offsetX = 0,
            offsetY = -25,
            offsetTime = 400),
            b.suckYou = !0,
    ...
    loadLevel: function() {
        for (; this.precedingPlatform.y + 2 * this.score > -100; ) {
            ...
            2 != a.type && (this.jetpackAppear < 0 && this.JETPACK_TIMES > 0 ? (this.JETPACK_TIMES--,
            a.hasBonusObject = 2,
            this.jetpackAppear = 1e4 * Math.random() + 1e4,
            this.spawnBonus(2, a)) : this.propellerAppear < 0 ? (a.hasBonusObject = 3,
            this.propellerAppear = 1e4 * Math.random() + 1e4,
            this.spawnBonus(3, a)) : Math.random() > .9 && (a.hasBonusObject = 0,
            this.spawnBonus(0, a))),
            this.precedingPlatform = a
        }
    },
    jumpState: function(a, b) {
        a.alive && b.alive && b.y + b.height / 2 + this.platformPool.y > a.bottom && a.body.velocity.y > 0 && (2 == b.type && (b.body.velocity.x = 0,
    ...
    obstacleUSE: function(a, b) {
        a.alive && !a.withBonus && b.alive && (b.y + b.height / 2 + this.obstaclePool.y > a.bottom && a.body.velocity.y > 0 && 4 != b.type ? (b.body.allowGravity = !0,
        a.body.velocity.y = -1080,
        ...
        this.sounds.jumponmonster.play()) : 4 == b.type || 6 == b.type ? (6 == b.type && (b.sounds.ufo_abduct.play(),
        this.stats.stats[25][1] += 1),
        4 == b.type && (b.sounds.black_hole.play(),
        this.stats.stats[26][1] += 1),
        this.gameOver(1, b)) : (this.gameOver(2, b),
        this.sounds.monster_hit.play(),
        this.stats.stats[24][1] += 1)),
        a.alive && a.withBonus && b.alive && 4 != b.type && 3 == a.bonusType && (b.kill(),
    ...
    spawnBonus: function(a, b) {
        ...
        c ? c.reset(b.x, b.top + 5, "bonus" + a, b, this.score) : (c = new Doodle.Bonus(this.game,b.x,b.top + 5,"bonus" + a,b,this.score,this.sounds,this.stats),
        this.bonusPool.add(c))
    },
    spawnPlatform: function(a, b, c, d, e, f, g) {
        var h = this.platformPool.getFirstExists(!1);
        return h ? h.reset(b, c, d, e, f, g) : (h = new Doodle.Platform(a,b,c,d,e,f,g),
        this.platformPool.add(h)),
        h
    },
    spanwObstacle: function(a, b, c, d) {
        var e = this.obstaclePool.getFirstExists(!1);
        return e ? e.reset(b, c, d) : (e = new Doodle.Obstacle(a,b,c,d,this.sounds,this.stats,this.obstaclePool),
        this.obstaclePool.add(e)),
        e
    },
    loadScene: function() {
    ...
    playerShoot: function(a) {
        ...
        1 == a && (velx = 1e3 * (this.game.input.activePointer.position.x - this.game.world.width / 2) / (this.game.world.width / 2),
    ...
    spawnBullet: function(a, b, c, d, e) {
        ...
        f ? f.reset(b, c, d) : (f = new Doodle.Bullet(a,b,c,d,this.stats),
        this.bulletPool.add(f)),
        f.body.velocity.y = -1920,
        f.body.allowGravity = !1,
        f.body.velocity.x = e
    },
    enemyCheck: function(a, b) {
        return 6 == b.type && b.animations.currentAnim ? (hz = a.y + 40 < b.y + this.obstaclePool.y,
        hz && this.enemyKill(a, b),
        !1) : void 0
    },
    enemyKill: function(a, b) {
        4 != b.type && (b.suckYou && (tween.stop(),
        tween2.stop(),
    ...
    setHighScore: function() {
        ...
        this.localTopScores.sort(a);
        for (var b = 0; 11 > b; b++)
            if ("findIndex" == this.localTopScores[b][0]) {
                this.setScoreName = b,
                this.localTopScores[b][0] = this.name;
                break
            }
    ...
    loadScoreMarks: function() {
        this.localTopScores.forEach(function(a) {
            scoreMark = new Phaser.Sprite(this.game,640,960 - 2 * a[1] - .48 * this.game.world.height,"atlas","scoreMark"),
            this.scoreMarkPool.add(scoreMark),
            scoreMark.anchor.setTo(1);
            this.nameMark = this.add.bitmapText(630, 960 - 2 * a[1] - .48 * this.game.world.height - 5, "DoodleFont", a[0], 24),
    ...
    inputTextSchedule: function(a) {
        this.player.inputTimer = this.player.playerTimer.add(20 * Phaser.Timer.SECOND / 60, function() {
            null == a && (this.gameOverStats.text = "your name:" + this.name + "|",
            this.inputTextSchedule("|")),
            "|" == a && (this.gameOverStats.text = "your name:" + this.name,
            this.inputTextSchedule())
        }, this)
    },
    writeScore: function() {
    ...
    achieveMentUnlock: function(a, b) {
        if (1 != this.stats.achievements[a][3] && (b || this.achievementsOrder.push(a),
        ...
        if (a && b) {
            ...
            e(f, function(a) {
                var b = a.message ? "message" : "data"
                  , d = a[b];
                console.log("game", d),
                d.mssg && "deviceorientation" == d.mssg && "Game" == Doodle.game.state.current && (console.log(d.event.alpha, d.event.beta, d.event.gamma),
                c.cursorContr || c.game.paused || !c.player.alive || (c.player.body.velocity.x = d.event.gamma * c.GYRO_SENSE * Math.cos(d.event.beta * Math.PI / 180) + c.calibratedValue,
                c.player.body.velocity.x > 0 ? c.player.frame < 2 && c.player.scale.setTo(-1, 1) : c.player.frame < 2 && c.player.scale.setTo(1, 1)))
            })
        }
...
Doodle.MenuState = {
    ...
    create: function() {
        ...
        for (var b = 0; b < a.length; b++) {
            ...
            f.inputEnabled = !0,
            f.link = d,
            f.events.onInputUp.add(function(a) {//window.open(a.link, "_blank")
            }, this)
        }
...
Doodle.PreloadState = {
    preload: function() {
        var a = (this.game.add.image(0, 0, "loadingscreen"),
...
Doodle.ScoresState = {
    ...
    create: function() {
        function a(a) {
            b.backgroundScores.getBounds().contains(b.game.input.x, b.game.input.y) && b.scrollMenu.visible && b.scrollMenu.y <= 0 && b.scrollMenu.y >= b.scrollLimit && (b.scrollMenu.y += 40 * b.game.input.mouse.wheelDelta,
            b.scrollMenu.y > 0 && (b.scrollMenu.y = 0),
            b.scrollMenu.y < b.scrollLimit && (b.scrollMenu.y = b.scrollLimit),
            b.textElements.y = b.scrollMenu.y),
            b.backgroundScores2.getBounds().contains(b.game.input.x, b.game.input.y) && b.scrollMenu2.visible && b.scrollMenu2.y <= 0 && b.scrollMenu2.y >= b.scrollLimit2 && (b.scrollMenu2.y += 40 * b.game.input.mouse.wheelDelta,
            b.scrollMenu2.y > 0 && (b.scrollMenu2.y = 0),
            b.scrollMenu2.y < b.scrollLimit2 && (b.scrollMenu2.y = b.scrollLimit2),
        ...
        var b = this
          , c = "unnamed"
          , d = 0;
        if (this.localTopScores.length > 0 ? (c = this.localTopScores[0][0],
        d = this.localTopScores[0][1],
        ...
        this.stats.achievements.forEach(function(a, b) {
            0 == a[3] ? icon = this.add.sprite(115, 285 + 105 * b, "atlas2", "ach") : icon = this.add.sprite(115, 285 + 105 * b, "atlas2", "ach" + b),
    ...
    spawnText: function(a, b, c, d, e, f, g) {
        ...
        return h ? (h.reset(b, c),
        h.text = d,
        h.fontSize = e) : (h = this.add.bitmapText(b, c, "DoodleFont", d, e),
        h.text = d,
        this.textElements.add(h)),
        h.align = f,
        h.anchor.setTo(g.x, g.y),
        h
    },
    setState: function(a) {
        ...
        "score" == a ? (this.backgroundScores.height = 810,
        this.scrollLimit = -318,
        ...
        this.scoresBtn.loadTexture("atlas2", "scoresBtn1")) : "stats" == a ? (this.statsBtn.loadTexture("atlas2", "statsBtn1"),
        ...
        }, this)) : "achievements" == a && (this.achievementsGroup.visible = !0,
    ...
    convertToHHMMSS: function(a) {
        ...
        a %= 60;
        var b = "";
        return 0 != hours && (b += hours + "h:"),
        0 != minutes && (b += minutes + "m:"),
        b += a + "s"
    },
    setLoad: function(a) {
        ...
        "local" == a && (this.localButton.loadTexture("atlas2", "localBtn1"),
        this.scrollMenu.visible = !0,
        this.setState("score")),
        "global" == a && (this.globalButton.loadTexture("atlas2", "globalBtn1"),
        this.scrollMenu2.visible = !0,
        this.dataTest && this.dataTest.forEach(function(a, b) {
...
Doodle.Bonus = function(a, b, c, d, e, f, g, h) {
    ...
    this.bonusAction = function(a, b, c) {
        ...
        b.y + b.height / 2 + this.bonusPool.y > a.bottom && a.body.velocity.y > 0 && ("bonus0" != b.type || b.used || (b.used = !0,
        b.loadTexture("atlas", "bonus01"),
        0 != a.frame && 2 != a.frame || (a.frame += 1,
        a.playerTimer.add(20 * Phaser.Timer.SECOND / 60, function() {
            a.frame -= 1
        }, this)),
        g.spring.play(),
        ...
        "bonus3" != b.type || b.used || a.withBonus || (this.stats.stats[19][1] += 1,
        ...
        "bonus2" != b.type || b.used || a.withBonus || (this.stats.stats[18][1] += 1,
...
Doodle.Bonus.prototype.reset = function(a, b, c, d, e) {
    ...
    this.used = !1,
    0 != d.body.velocity.x && (this.body.velocity.x = d.body.velocity.x,
    d.child = this);
...
Doodle.Obstacle = function(a, b, c, d, e, f, g) {
    Phaser.Sprite.call(this, a, b, c, "atlas", "obstacle" + d),
    this.sounds = e,
    this.stats = f,
    this.reset(b, c, d),
    this.pool = g
...
Doodle.Obstacle.prototype.reset = function(a, b, c) {
    ...
    11 == c && (this.health = 2),
    4 == c && (this.body.setSize(80, 80, this.width / 2 - 40, this.height / 2 - 40),
    this.game.world.sendToBack(this)),
    9 == c && (this.body.velocity.x = 360,
    this.scale.x *= -1),
    6 == c && (this.animations.currentAnim = null,
    ...
    10 == c && (this.animations.add("fly", ["atlas", "obstacle10", "but1", "but2", "but3", "but4", "but3", "but2", "but1", "obstacle10"], 24, !0),
    this.play("fly"))
}
,
...
Doodle.Obstacle.prototype.kill = function() {
    ...
    this.pool.forEachAlive(function(c) {
        6 == c.type && (a += 1),
        7 != c.type && 8 != c.type && 9 != c.type && 10 != c.type && 11 != c.type || (b += 1)
    }, this),
...
Doodle.Platform.prototype.reset = function(a, b, c, d, e, f) {
    ...
    this.body.allowGravity = !1,
    this.body.immovable = !0,
    null == f && (2 != d.type && Math.random() < .2 && (this.type = 2,
    this.loadTexture("atlas", "platform2")),
    e > 5500 && 100 * Math.random() < e / 400 && (this.moving = !0,
    2 != this.type && (this.type = 1,
    this.loadTexture("atlas", "platform1")),
    this.setVelocity = 60 * (.5 + .5 * Math.random() + e / 3e4) * 2,
    this.setVelocity > 300 ? this.body.velocity.x = 300 : this.body.velocity.x = this.setVelocity)),
    null != f && (this.loadTexture("atlas", "platform" + f),
    this.type = f,
    1 == f && (this.setVelocity = 60 * (.5 + .5 * Math.random() + e / 3e4) * 2,
    this.setVelocity > 300 ? this.body.velocity.x = 300 : this.body.velocity.x = this.setVelocity))
}
,
